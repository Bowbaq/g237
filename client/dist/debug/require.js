...
this["JST"]["app/templates/layout/page.html"] = function(obj){
var __p='';var print=function(){__p+=Array.prototype.join.call(arguments, '')};
with(obj||{}){
__p+='<div data-role="header" data-id="#header" data-position="fixed">\n    <!-- Header goes here -->\n</div>\n<div data-role="content">\n    <!-- Content goes here -->\n</div>\n<div data-role="footer" data-id="#footer" data-position="fixed">\n    <div data-role="navbar">\n\t\t<ul>\n\t\t\t<li><a href="a.html">Info</a></li>\n\t\t\t<li><a href="b.html">Friends</a></li>\n\t\t\t<li><a href="c.html">Albums</a></li>\n\t\t\t<li><a href="d.html">Emails</a></li>\n\t\t</ul>\n\t</div><!-- /navbar -->\n</div>';
}
return __p;
};

this["JST"]["app/templates/login.html"] = function(obj){
var __p='';var print=function(){__p+=Array.prototype.join.call(arguments, '')};
with(obj||{}){
__p+='';
}
...
this["JST"]["app/templates/project.html"] = function(obj){
var __p='';var print=function(){__p+=Array.prototype.join.call(arguments, '')};
with(obj||{}){
__p+='';
}
...
var __p='';var print=function(){__p+=Array.prototype.join.call(arguments, '')};
with(obj||{}){
__p+='<ul data-role="listview"  data-inset="true">\n    <li><a href="#page1">Page 1</a></li>\n    <li><a href="#page2">Page 2</a></li>\n</ul>';
}
return __p;
};;
var jam = {
...
function(app) {
  ...
  Auth.Model = Backbone.Model.extend({
    ...
    // localStorage: new Store('g237-auth'),
...
function(app, Auth, Test) {
  ...
  var Router = Backbone.Router.extend({
    ...
    index: function () {
      var col = new Test.Collection();
      var main = new Backbone.Layout({
        template: "layout/page",

        // In the secondary column, put a new Login View.
        views: {
          '[data-role="content"]': new Test.Views.Layout({
            collection: col
          })
        }
      });
